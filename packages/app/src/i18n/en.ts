export const dict = {
  ...
  "summary.tab.plan": "Plan",
  "summary.tab.sources": "Sources",
  "summary.tab.artifacts": "Artifacts",
  "summary.noTasks": "No active tasks",
  "summary.noSources": "No sources referenced",
  "summary.noArtifacts": "No artifacts produced",
  "summary.closePanel": "Close panel",

  "memory.tab.project": "Project",
  "memory.tab.session": "Session",
  "memory.tab.notes": "Notes",
  ...
  "review.filesChanged": "{{count}} file{{plural}} changed",
  "review.approve": "Approve",
  "review.reject": "Reject",
  "review.approved.description": "All changes have been accepted",
  "review.rejected.description": "All changes have been rejected",

  "session.summary.toggle": "Toggle Summary Panel",
}
