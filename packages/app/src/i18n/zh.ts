...
export const dict = {
  ...
  "summary.tab.plan": "计划",
  "summary.tab.sources": "引用",
  "summary.tab.artifacts": "产物",
  "summary.noTasks": "暂无活跃任务",
  "summary.noSources": "暂无引用文件",
  "summary.noArtifacts": "暂无产物",
  "summary.closePanel": "关闭面板",

  "memory.tab.project": "项目",
  "memory.tab.session": "会话",
  "memory.tab.notes": "笔记",
  "memory.tab.tasks": "任务",
  ...
  "review.approved": "已批准",
  "review.rejected": "已拒绝",
  "review.noReviews": "暂无审查",
  "review.loading": "加载中...",
  "review.filesChanged": "{{count}} 个文件已更改",
  "review.approve": "批准",
  "review.reject": "拒绝",
  "review.approved.description": "所有更改已被接受",
  "review.rejected.description": "所有更改已被拒绝",

  "session.summary.toggle": "切换摘要面板",
